...
from Graph.nodes import topic_analyzer_node, persona_generator_node, question_generator_node, search_node, content_extractor_node, embedder_node, synthesizer_node, outline_generator_node, writer_node, research_completed_node
...
workflow.add_node("research_complete", research_completed_node)
...
workflow.add_edge("write", "research_complete")
workflow.add_edge("research_complete", END)
